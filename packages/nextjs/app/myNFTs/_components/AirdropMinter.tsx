...
import { PaperAirplaneIcon, UserGroupIcon, PhotoIcon, TagIcon, DocumentTextIcon, LinkIcon } from "@heroicons/react/24/outline";
...
export const AirdropMinter = () => {
    ...
    return (
        <div className="card bg-base-100 shadow-xl w-full max-w-md mx-auto border border-base-300">
            <div className="card-body">
                ...
                <div className="form-control w-full">
                    ...
                    <textarea
                        className="textarea textarea-bordered min-h-24 focus:outline-none focus:bg-transparent focus:text-gray-400 font-mono text-sm"
                        placeholder={`0xabc...
0xdef...`}
                        value={addressesText}
                    ...
                    <div className="text-xs mt-1 flex justify-between">
                        <span className="opacity-70">有效: {recipients.length}</span>
                        {invalidCount > 0 && <span className="text-error">无效: {invalidCount}</span>}
                    </div>
                </div>
                ...
                <div className="form-control w-full">
                    ...
                    <input
                        type="text"
                        className="input input-bordered focus:outline-none focus:bg-transparent focus:text-gray-400"
                        value={name}
                ...
                <div className="card-actions justify-end mt-6">
                    ...
                    >
                        {isAirdropping ? (
                            ...
                            <>
                                开始空投 <PaperAirplaneIcon className="h-4 w-4 ml-1" />
                            </>
                        )}
                    </button>
                </div>
